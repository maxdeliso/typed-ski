...
import { makeControlPtr } from "../../shared/arena.ts";
      ...
      for (;;) {
        ...
        if (isTypedYield) {
          ...
          try {
            ...
            // When resubmitting a parked control pointer, `max_steps` is ignored by the worker
            // because the saved continuation already carries the remaining budget.
