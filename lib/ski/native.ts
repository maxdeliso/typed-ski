 ...
 */
export const mkNativeTerminal = (sym: SKITerminalSymbol): NativeTerminal => ({ kind: 'terminal', sym });
...
const stepNative = (e: NativeExpr): NativeStepResult => {
  ...
  if (e.kind === 'non-terminal' && e.lft.kind === 'inc' && e.rgt.kind === 'num') {
