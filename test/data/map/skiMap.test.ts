...
Deno.test("SKIAVL", () => {
  Deno.test("should return undefined for a non-existent key", () => {
  ...
  Deno.test("should store and retrieve a value for an empty key", () => {
    let tree = createMap();
  ...
  Deno.test("should store and retrieve a value for a simple key", () => {
    let tree = createMap();
    const key: SKIChar[] = ["S"];
  ...
  Deno.test("should handle overlapping keys correctly", () => {
    let tree = createMap();
  ...
  Deno.test("should update an existing key immutably", () => {
    let tree1 = createMap();
    const key: SKIChar[] = ["(", "I", ")"];
  ...
  Deno.test("should correctly update keys that share a common prefix", () => {
    let tree = createMap();
  ...
  Deno.test("should overwrite a previously inserted value for the same key (in place)", () => {
    let tree = createMap();
  ...
  Deno.test("should handle multiple distinct keys that only differ at the first character", () => {
    let tree = createMap();
  ...
  Deno.test("should return undefined if we search for a prefix of an existing key", () => {
    let tree = createMap();
    // The key is ['S','K','I']
  ...
  Deno.test("should handle a larger key and confirm retrieval", () => {
    let tree = createMap();
