...
Deno.test("moduleLinker edge cases (coverage)", async (t) => {
  await t.step("createProgramSpace: export listed but definition missing", () => {
  ...
  await t.step("resolveCrossModuleDependencies: getModuleInfo missing module", () => {
  ...
  await t.step("findMainFunction: multiple candidates when bypassing export validation", () => {
  ...
  await t.step("term resolution: imported ref present in env but missing in global index", () => {
